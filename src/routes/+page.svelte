		...
		<form class="flex flex-col" on:submit|preventDefault>
			<div class="flex justify-between items-center">
				...
				<div class="flex justify-between w-3/5">
					<Input label="Primary Type" defaultText="Docent" bind:value={$cardData.primaryType} />
					<Input label="Secondary Type" defaultText="Frans" bind:value={$cardData.secondaryType} />
				</div>
			</div>
			...
			<div class="infogrid grid grid-cols-2 my-2">
				<div class="flex flex-col mr-auto">
					<Input
						label="Ability"
						defaultText="2x Critical Hit chance"
						bind:value={$cardData.ability}
					/>
					<Input
						label="Description"
